...
- [x] Release version: 20260628-141026
- [x] Project: gympixapp
- [x] Snapshot generated in docs/deployments/firestore/20260628-141026
- [x] SHA256 captured in manifest.json
- [x] Flutter tests: passed
- [x] Firestore emulator tests: passed
- [x] Deploy status: skipped
